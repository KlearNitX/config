repeat wait()
until game:IsLoaded()
local TableChat = {"non","gà","ezzzz","mẹ mày gà", "gà vậy em", "cay rồi", "quá non"}
spawn(function()
    while wait() do 
        pcall(function()
...
getgenv().Setting = {
    ...
    ["Webhook"] = {
        ["Enabled"] = true,
        ["Url Webhook"] = "https://discord.com/api/webhooks/1203918942158987264/eV_aPWagVbJXud0dlMBeSW2Xzq6XJSG-83rJvpPKINjfW_yL5qX9pYZiA0U2tWaXK-av", --Your Url
    },
    ["Misc"] = {
